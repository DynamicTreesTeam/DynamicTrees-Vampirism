package com.harleyoconnor.dtvampirism.tree;
...
import com.harleyoconnor.dtvampirism.cell.DTVampirismLeafClusters;

public class MagicSpecies extends Species {

    public static final TypedRegistry.EntryType<Species> TYPE = createDefaultType(MagicSpecies::new);

    public MagicSpecies(ResourceLocation name, Family family, LeavesProperties leavesProperties) {
        super(name, family, leavesProperties);
    }

    @Override
    public NodeInspector getNodeInflator(SimpleVoxmap leafMap) {
        return new NodeInflatorMagic(this, leafMap);
    }

    public class NodeInflatorMagic implements NodeInspector {
        ...
        public NodeInflatorMagic(Species species, SimpleVoxmap leafMap) {
        ...
        public boolean returnRun(BlockState state, LevelAccessor level, BlockPos pos, Direction fromDir) {
            ...
            if (branch != null) {
                ...
                if (isTop) {
                    ...
                    SimpleVoxmap leafCluster = DTVampirismLeafClusters.MAGIC_TOP;
